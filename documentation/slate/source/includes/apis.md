...
<h2 id="access-points-api">Access Points</h2>
...
Access points are collected from the [stop points](#stop-point) of the coverage and deduplicated
so that each unique access point appears only once.

For more information about the object structure, refer to the [Access Point](#access-point) object description.

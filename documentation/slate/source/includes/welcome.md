...
<aside class="notice">
    Please be advised that the creation of a new coverage on our servers requires resources,
    so on some data integration we try to make sure that the amount of requests justifies the use of those resources.
    </br>
    Your feedbacks and requests are very welcome so we choose the most usefull new coverages depending on available resources.
</aside>
...
A mailing list is available to ask question or request [new data](#about_data) integration: <a href="mailto:navitia@googlegroups.com">navitia@googlegroups.com</a>

# -*- coding: utf-8 -*-
#
# NAViTiA2 documentation build configuration file, created by
...
extensions = ['sphinx.ext.todo', 'sphinx.ext.pngmath', 'sphinx.ext.ifconfig', 'sphinxcontrib.aafig', 'sphinxcontrib.mscgen']
...
latex_documents = [
  ('index', 'NAViTiA2.tex', u'NAViTiA2 Documentation',
   u'Canal TP', 'manual'),
]
...
man_pages = [
    ('index', 'navitia2', u'NAViTiA2 Documentation',
     [u'Canal TP'], 1)
]

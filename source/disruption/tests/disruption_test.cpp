...
BOOST_FIXTURE_TEST_CASE(error, Params) {
    ...
    pbnavitia::Response resp = navitia::disruption::disruptions(*(b.data), "AAA", period,
            1, 10, 0, "network.uri=network:R", forbidden_uris, navitia::type::OdtLevel_e::all);
...
BOOST_FIXTURE_TEST_CASE(network_filter1, Params) {
    ...
    pbnavitia::Response resp = navitia::disruption::disruptions(*(b.data),
            "20131220T125000",period, 1, 10, 0, "network.uri=network:R", forbidden_uris, navitia::type::OdtLevel_e::all);
...
BOOST_FIXTURE_TEST_CASE(network_filter2, Params) {
    std::vector<std::string> forbidden_uris;
    pbnavitia::Response resp = navitia::disruption::disruptions(*(b.data),
            "20131224T125000", period, 1, 10, 0, "network.uri=network:M", forbidden_uris, navitia::type::OdtLevel_e::all);
...
BOOST_FIXTURE_TEST_CASE(line_filter, Params) {
    std::vector<std::string> forbidden_uris;
    pbnavitia::Response resp = navitia::disruption::disruptions(*(b.data),
            "20131220T125000", period, 1 ,10 ,0 , "line.uri=line:S", forbidden_uris, navitia::type::OdtLevel_e::all);
...
BOOST_FIXTURE_TEST_CASE(Test1, Params) {
    std::vector<std::string> forbidden_uris;
    pbnavitia::Response resp = navitia::disruption::disruptions(*(b.data),
            "20140101T0900", period, 1, 10, 0, "", forbidden_uris, navitia::type::OdtLevel_e::all);
...
BOOST_FIXTURE_TEST_CASE(Test2, Params) {
    std::vector<std::string> forbidden_uris;
    pbnavitia::Response resp = navitia::disruption::disruptions(*(b.data),
            "20140103T0900", period, 1, 10, 0, "", forbidden_uris, navitia::type::OdtLevel_e::all);
    BOOST_REQUIRE_EQUAL(resp.disruptions_size(), 1);
...
BOOST_FIXTURE_TEST_CASE(Test3, Params) {
    std::vector<std::string> forbidden_uris;
    pbnavitia::Response resp = navitia::disruption::disruptions(*(b.data),
            "20140113T0900", period, 1, 10, 0, "", forbidden_uris, navitia::type::OdtLevel_e::all);
    BOOST_REQUIRE_EQUAL(resp.disruptions_size(), 1);
...
BOOST_FIXTURE_TEST_CASE(Test4, Params) {
    std::vector<std::string> forbidden_uris;
    pbnavitia::Response resp = navitia::disruption::disruptions(*(b.data),
            "20140203T0900", period, 1 , 10, 0, "", forbidden_uris, navitia::type::OdtLevel_e::all);
    BOOST_REQUIRE_EQUAL(resp.response_type(), pbnavitia::ResponseType::NO_SOLUTION);
}
...
BOOST_FIXTURE_TEST_CASE(Test5, Params) {
    std::vector<std::string> forbidden_uris;
    pbnavitia::Response resp = navitia::disruption::disruptions(*(b.data),
            "20140212T0900", period, 1, 10, 0, "", forbidden_uris, navitia::type::OdtLevel_e::all);
    BOOST_REQUIRE_EQUAL(resp.response_type(), pbnavitia::ResponseType::NO_SOLUTION);
}
...
BOOST_FIXTURE_TEST_CASE(Test7, Params) {
    std::vector<std::string> forbidden_uris;
    pbnavitia::Response resp = navitia::disruption::disruptions(*(b.data),
            "20140113T1801", period, 1, 10, 0, "", forbidden_uris, navitia::type::OdtLevel_e::all);
    BOOST_REQUIRE_EQUAL(resp.disruptions_size(), 1);

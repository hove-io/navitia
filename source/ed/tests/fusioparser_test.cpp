...
BOOST_AUTO_TEST_CASE(parse_small_ntfs_dataset) {
    ...
    BOOST_REQUIRE_EQUAL(vj1->stop_time_list[0]->headsign, "NULL");
    BOOST_REQUIRE_EQUAL(vj1->stop_time_list[1]->headsign, "NULL");
    BOOST_REQUIRE_EQUAL(vj1->stop_time_list[2]->headsign, "NULL");
    BOOST_REQUIRE_EQUAL(vj1->stop_time_list[3]->headsign, "NULL");

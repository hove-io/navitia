...
boost::local_time::tz_database fill_tz_db() {
    ...
    // close your eyes...
    // Note: I did not manage to wrap this in a function returning the stringstream because gcc laks the stringstream
    // move constructor
    std::stringstream ss;

    // no header for string init
    //"ID,STD ABBR,STD NAME,DST ABBR,DST NAME,GMT offset,DST adjustment,DST Start Date rule,Start time,DST End date
    // rule,End time"
    ss << "Africa/Abidjan,GMT,GMT,,,+00:00:00,+00:00:00,,,,+00:00:00"
       ...
       << "\n"
       << "America/Los_Angeles,PST,Pacific Standard Time,PDT,Pacific Daylight "
          "Time,-08:00:00,+01:00:00,2;0;3,+02:00:00,1;0;11,+02:00:00"
       << "\n"

...
If you want to switch your POI source back to OSM, you will need to set the `parse_pois_from_osm` boolean to `true` by using an api tyr `DELETE $HOST/v0/instances/$INSTANCE_NAME/actions/migrate_from_poi_to_osm` and launch again an osm2ed data integration job.

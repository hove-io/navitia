...
struct OSMRelation {
    ...
    OSMRelation(std::vector<osmpbfreader::Reference> refs,
                std::string insee,
...
struct ReadRelationsVisitor {
    ...
    void node_callback(OSMId, double, double, const osmpbfreader::Tags&) {}
    void relation_callback(OSMId, const osmpbfreader::Tags& tags, const osmpbfreader::References& refs);
    void way_callback(OSMId, const osmpbfreader::Tags&, const std::vector<OSMId>&) {}
};
struct ReadWaysVisitor {
    ...
    void node_callback(OSMId, double, double, const osmpbfreader::Tags&) {}
    void relation_callback(OSMId, const osmpbfreader::Tags&, const osmpbfreader::References&) {}
    void way_callback(OSMId, const osmpbfreader::Tags& tags, const std::vector<OSMId>& nodes_refs);
};

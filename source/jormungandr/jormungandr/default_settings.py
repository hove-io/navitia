...
JORMUNGANDR_READY_DURATION_MIN_S = float(os.getenv('JORMUNGANDR_READY_DURATION_MIN_S', 3600))
JORMUNGANDR_READY_DURATION_MAX_DELTA_S = float(os.getenv('JORMUNGANDR_READY_DURATION_MAX_DELTA_S', 3600))

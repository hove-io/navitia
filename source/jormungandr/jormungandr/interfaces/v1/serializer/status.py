...
class ParametersSerializer(serpy.Serializer):
    ...
    mobility_scenarios = Field(schema_type=bool)
...
class StreetNetworkSerializer(OutsideServiceCommon):
    ...
    lapse_time_matrix_to_retry = MethodField(schema_type=str, display_none=False)
    ...
    def get_lapse_time_matrix_to_retry(self, obj):
        return obj.get('lapse_time_matrix_to_retry', None)

...
from jormungandr.parking_space_availability.car.car_parking_provider_manager import CarParkingProviderManager
car_parking_provider_manager = CarParkingProviderManager(app.config['CAR_PARKING_PROVIDER'])

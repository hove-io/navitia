...
ACCESS_POINTS_PHYSICAL_MODES = ("physical_mode:LongDistanceTrain", "physical_mode:LocalTrain", "physical_mode:Train", "physical_mode:RapidTransit", "physical_mode:Metro")

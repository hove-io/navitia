...
def filter_olympic_site_origin_olympic_site_to_delete_tag_test():
    ...
    request = {
        "wheelchair": False,
        "_keep_olympics_journeys": True,
        "olympic_site_params": DEFAULT_OLYMPIC_SITE_PARAMS,
    }
    journey_filter.filter_olympic_site_by_min_pt_duration([response], instance, request, origin, destination)

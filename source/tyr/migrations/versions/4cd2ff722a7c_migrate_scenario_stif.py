...
def upgrade():
    op.add_column(
        'instance', sa.Column('final_line_filter', sa.Boolean(), server_default='false', nullable=False)
    )
    op.add_column(
        'instance', sa.Column('max_extra_second_pass', sa.Integer(), server_default='0', nullable=False)
    )

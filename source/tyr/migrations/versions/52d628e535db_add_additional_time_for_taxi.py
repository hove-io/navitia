...
def upgrade():
    ...
    op.add_column('instance', sa.Column('additional_time_after_first_section_taxi', sa.Integer(), nullable=False))
    op.add_column('instance', sa.Column('additional_time_before_last_section_taxi', sa.Integer(), nullable=False))

...
parameters = Table(
    ...
    *[
        ...
        Column(
            'shape', Geography(geometry_type='MULTIPOLYGON', srid=4326, spatial_index=False), primary_key=False
        ),
...
associated_calendar = Table(
    ...
    *[
        Column(
            ...
            primary_key=True,
            nullable=False,
            default=text(u'nextval(\'"navitia".associated_calendar_id_seq\'::regclass)'),
        ),
...
associated_exception_date = Table(
    ...
    *[
        Column(
            ...
            primary_key=True,
            nullable=False,
            default=text(u'nextval(\'"navitia".associated_exception_date_id_seq\'::regclass)'),
        ),
        Column('datetime', DATE(), primary_key=False, nullable=False),
        Column(
            'type_ex', ENUM(u'Add', u'Sub', name='associated_exception_type'), primary_key=False, nullable=False
        ),
...
rel_metavj_associated_calendar = Table(
...
vehicle_properties = Table(
    ...
    *[
        Column(
            ...
            primary_key=True,
            nullable=False,
            default=text(u'nextval(\'"navitia".vehicle_properties_id_seq\'::regclass)'),
        ),
...
origin_destination = Table(
    ...
    *[
        ...
        Column(
            'origin_mode',
            ENUM(u'Zone', u'StopArea', u'Mode', name='fare_od_mode'),
            primary_key=False,
            nullable=False,
        ),
...
vehicle_journey = Table(
    ...
    *[
        ...
        Column(
            'vj_class',
            ENUM(u'Theoric', u'Adapted', u'RealTime', name='vj_classification'),
        ...
        ForeignKeyConstraint(
            ['physical_mode_id'], [u'navitia.physical_mode.id'], name=u'vehicle_journey_physical_mode_id_fkey'
        ),
        ForeignKeyConstraint(
...
stop_time = Table(
    ...
    *[
        Column(
            ...
            primary_key=True,
            nullable=False,
            default=text(u'nextval(\'"navitia".stop_time_id_seq\'::regclass)'),
        ),
        ...
        ForeignKeyConstraint(
            ['stop_point_id'], [u'navitia.stop_point.id'], name=u'stop_time_stop_point_id_fkey'
        ),
    ],
    schema='navitia'
)
...
period = Table(
    ...
    *[
        Column(
            ...
            primary_key=True,
            nullable=False,
            default=text(u'nextval(\'"navitia".period_id_seq\'::regclass)'),
        ),
        Column('calendar_id', BIGINT(), primary_key=False, nullable=False),
...
week_pattern = Table(
    ...
    *[
        Column(
            ...
            primary_key=True,
            nullable=False,
            default=text(u'nextval(\'"navitia".week_pattern_id_seq\'::regclass)'),
        ),
...
exception_date = Table(
    ...
    *[
        Column(
            ...
            primary_key=True,
            nullable=False,
            default=text(u'nextval(\'"navitia".exception_date_id_seq\'::regclass)'),
        ),
        Column('datetime', DATE(), primary_key=False, nullable=False),
...
calendar = Table(
    ...
    *[
        Column(
            ...
            primary_key=True,
            nullable=False,
            default=text(u'nextval(\'"navitia".calendar_id_seq\'::regclass)'),
        ),
        Column('uri', TEXT(), primary_key=False, nullable=False),
        Column('name', TEXT(), primary_key=False, nullable=False),
...
transition = Table(
    ...
    *[
        ...
        Column(
            'global_condition',
            ENUM(u'nothing', u'exclusive', u'with_changes', name='fare_transition_condition'),
            primary_key=False,
            nullable=False,
        ),

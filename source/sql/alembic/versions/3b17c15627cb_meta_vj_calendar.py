...
def upgrade():
    op.create_table('associated_calendar',
    sa.Column('id', sa.BIGINT(), nullable=False),
    sa.Column('calendar_id', sa.BIGINT(), nullable=False),
    sa.Column('name', sa.TEXT(), nullable=False),
    sa.ForeignKeyConstraint(['calendar_id'], [u'navitia.calendar.id'], name=u'associated_calendar_calendar_fkey'),
    sa.PrimaryKeyConstraint('id'),
    schema='navitia'
    )
    op.create_table('associated_exception_date',
    sa.Column('id', sa.BIGINT(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['associated_calendar_id'], [u'navitia.associated_calendar.id'], name=u'associated_exception_date_associated_calendar_fkey'),
    sa.PrimaryKeyConstraint('id'),
    schema='navitia'
    )
    op.create_table('rel_metavj_associated_calendar',
    sa.Column('meta_vj_id', sa.BIGINT(), nullable=True),
    sa.Column('associated_calendar_id', sa.BIGINT(), nullable=True),
    sa.ForeignKeyConstraint(['meta_vj_id'], [u'navitia.meta_vj.id'], name=u'rel_metavj_associated_calendar_meta_vj_fkey'),
    sa.ForeignKeyConstraint(['associated_calendar_id'], [u'navitia.associated_calendar.id'], name=u'rel_metavj_associated_calendar_associated_calendar_fkey'),
    schema='navitia'
    )

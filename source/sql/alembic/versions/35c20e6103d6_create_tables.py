...
def upgrade():
    ...
    op.create_table('commercial_mode',
    sa.Column('id', sa.BIGINT(), nullable=False),
    ...
    op.create_table('connection_kind',
    sa.Column('id', sa.BIGINT(), nullable=False),
    sa.Column('name', sa.TEXT(), nullable=False),
    sa.PrimaryKeyConstraint('id'),
    schema='navitia'
    ...
    sa.ForeignKeyConstraint(['week_pattern_id'], [u'navitia.week_pattern.id'], name=u'calendar_week_pattern_id_fkey'),
    sa.PrimaryKeyConstraint('id'),
    schema='navitia'
    )
    op.create_table('dated_ticket',
    sa.Column('id', sa.BIGINT(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['ticket_id'], [u'navitia.ticket.ticket_key'], name=u'dated_ticket_ticket_id_fkey'),
    sa.PrimaryKeyConstraint('id'),
    schema='navitia'
    )
    ...
    sa.ForeignKeyConstraint(['message_status_id'], [u'realtime.message_status.id'], name=u'message_message_status_id_fkey'),
    sa.ForeignKeyConstraint(['object_type_id'], [u'navitia.object_type.id'], name=u'message_object_type_id_fkey'),
    sa.PrimaryKeyConstraint('id'),
    schema='realtime'
    )
    ...
    sa.Column('the_geog', ga.Geography(geometry_type='LINESTRING', srid=4326, spatial_index=False), nullable=False),
    ...
    sa.ForeignKeyConstraint(['master_admin_id'], [u'georef.admin.id'], name=u'rel_admin_admin_master_admin_id_fkey'),
    sa.PrimaryKeyConstraint('master_admin_id', 'admin_id'),
    schema='georef'
    )
    op.create_table('rel_way_admin',
    sa.Column('admin_id', sa.BIGINT(), nullable=False),
    sa.Column('way_id', sa.BIGINT(), nullable=False),
    ...
    sa.Column('timezone', sa.TEXT(), nullable=True),
    sa.ForeignKeyConstraint(['properties_id'], [u'navitia.properties.id'], name=u'stop_area_properties_id_fkey'),
    sa.PrimaryKeyConstraint('id'),
    schema='navitia'
    )
    op.create_table('house_number',
    ...
    sa.Column('sort', sa.INTEGER(), nullable=False),
    sa.ForeignKeyConstraint(['commercial_mode_id'], [u'navitia.commercial_mode.id'], name=u'line_commercial_mode_id_fkey'),
    ...
    sa.Column('global_condition', postgresql.ENUM(u'nothing', u'exclusive', u'with_changes', name='fare_transition_condition'), nullable=False),
    sa.Column('ticket_id', sa.TEXT(), nullable=True),
    sa.ForeignKeyConstraint(['ticket_id'], [u'navitia.ticket.ticket_key'], name=u'transition_ticket_id_fkey'),
    sa.PrimaryKeyConstraint('id'),
    schema='navitia'
    )
    op.create_table('poi',
    ...
    op.create_table('at_perturbation',
    sa.Column('id', sa.BIGINT(), nullable=False),
    sa.Column('uri', sa.TEXT(), nullable=False),
    sa.Column('start_application_date', postgresql.TIMESTAMP(timezone=True), nullable=False),
    sa.Column('end_application_date', postgresql.TIMESTAMP(timezone=True), nullable=False),
    ...
    sa.Column('object_type_id', sa.INTEGER(), nullable=False),
    sa.Column('is_active', sa.BOOLEAN(), nullable=False),
    sa.ForeignKeyConstraint(['object_type_id'], [u'navitia.object_type.id'], name=u'at_perturbation_object_type_id_fkey'),
    sa.PrimaryKeyConstraint('id'),
    schema='realtime'
    )
    op.create_table('admin_stop_area',
    sa.Column('admin_id', sa.TEXT(), nullable=False),
    sa.Column('stop_area_id', sa.BIGINT(), nullable=False),
    sa.ForeignKeyConstraint(['stop_area_id'], [u'navitia.stop_area.id'], name=u'admin_stop_area_stop_area_id_fkey'),
    schema='navitia'
    )
    op.create_table('localized_message',
    sa.Column('message_id', sa.BIGINT(), nullable=False),
    sa.Column('language', sa.TEXT(), nullable=False),
    sa.Column('body', sa.TEXT(), nullable=False),
    sa.Column('title', sa.TEXT(), nullable=True),
    sa.ForeignKeyConstraint(['message_id'], [u'realtime.message.id'], name=u'localized_message_message_id_fkey'),
    sa.PrimaryKeyConstraint('message_id', 'language'),
    schema='realtime'
    )
    op.create_table('exception_date',
    sa.Column('id', sa.BIGINT(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['calendar_id'], [u'navitia.calendar.id'], name=u'exception_date_calendar_id_fkey'),
    sa.PrimaryKeyConstraint('id'),
    schema='navitia'
    )
    ...
    op.create_table('poi_properties',
    ...
    sa.ForeignKeyConstraint(['properties_id'], [u'navitia.properties.id'], name=u'stop_point_properties_id_fkey'),
    sa.ForeignKeyConstraint(['stop_area_id'], [u'navitia.stop_area.id'], name=u'stop_point_stop_area_id_fkey'),
    sa.PrimaryKeyConstraint('id'),
    schema='navitia'
    )
    op.create_table('rel_calendar_line',
    sa.Column('calendar_id', sa.BIGINT(), nullable=False),
    sa.Column('line_id', sa.BIGINT(), nullable=False),
    sa.ForeignKeyConstraint(['calendar_id'], [u'navitia.calendar.id'], name=u'rel_calendar_line_calendar_id_fkey'),
    ...
    op.create_table('rel_line_company',
    sa.Column('line_id', sa.BIGINT(), nullable=False),
    sa.Column('company_id', sa.BIGINT(), nullable=False),
    sa.ForeignKeyConstraint(['company_id'], [u'navitia.company.id'], name=u'rel_line_company_company_id_fkey'),
    ...
    sa.ForeignKeyConstraint(['connection_type_id'], [u'navitia.connection_type.id'], name=u'connection_connection_type_id_fkey'),
    sa.ForeignKeyConstraint(['departure_stop_point_id'], [u'navitia.stop_point.id'], name=u'connection_departure_stop_point_id_fkey'),
    sa.ForeignKeyConstraint(['destination_stop_point_id'], [u'navitia.stop_point.id'], name=u'connection_destination_stop_point_id_fkey'),
    sa.ForeignKeyConstraint(['properties_id'], [u'navitia.properties.id'], name=u'connection_properties_id_fkey'),
    ...
    sa.ForeignKeyConstraint(['physical_mode_id'], [u'navitia.physical_mode.id'], name=u'journey_pattern_physical_mode_id_fkey'),
    ...
    sa.ForeignKeyConstraint(['adapted_validity_pattern_id'], [u'navitia.validity_pattern.id'], name=u'vehicle_journey_adapted_validity_pattern_id_fkey'),
    sa.ForeignKeyConstraint(['company_id'], [u'navitia.company.id'], name=u'vehicle_journey_company_id_fkey'),
    sa.ForeignKeyConstraint(['journey_pattern_id'], [u'navitia.journey_pattern.id'], name=u'vehicle_journey_journey_pattern_id_fkey'),
    sa.ForeignKeyConstraint(['next_vehicle_journey_id'], [u'navitia.vehicle_journey.id'], name=u'vehicle_journey_next_vehicle_journey_id_fkey'),
    sa.ForeignKeyConstraint(['previous_vehicle_journey_id'], [u'navitia.vehicle_journey.id'], name=u'vehicle_journey_previous_vehicle_journey_id_fkey'),
    sa.ForeignKeyConstraint(['theoric_vehicle_journey_id'], [u'navitia.vehicle_journey.id'], name=u'vehicle_journey_theoric_vehicle_journey_id_fkey'),
    sa.ForeignKeyConstraint(['validity_pattern_id'], [u'navitia.validity_pattern.id'], name=u'vehicle_journey_validity_pattern_id_fkey'),
    sa.ForeignKeyConstraint(['vehicle_properties_id'], [u'navitia.vehicle_properties.id'], name=u'vehicle_journey_vehicle_properties_id_fkey'),
    sa.PrimaryKeyConstraint('id'),
    schema='navitia'
    )
    ...
    sa.ForeignKeyConstraint(['journey_pattern_id'], [u'navitia.journey_pattern.id'], name=u'journey_pattern_point_journey_pattern_id_fkey'),
    sa.ForeignKeyConstraint(['stop_point_id'], [u'navitia.stop_point.id'], name=u'journey_pattern_point_stop_point_id_fkey'),
    sa.PrimaryKeyConstraint('id'),
    schema='navitia'
    )
    ...
    sa.Column('properties_id', sa.BIGINT(), nullable=True),
    sa.ForeignKeyConstraint(['journey_pattern_point_id'], [u'navitia.journey_pattern_point.id'], name=u'stop_time_journey_pattern_point_id_fkey'),
    sa.ForeignKeyConstraint(['properties_id'], [u'navitia.properties.id'], name=u'stop_time_properties_id_fkey'),
    sa.ForeignKeyConstraint(['vehicle_journey_id'], [u'navitia.vehicle_journey.id'], name=u'stop_time_vehicle_journey_id_fkey'),
    sa.PrimaryKeyConstraint('id'),
    schema='navitia'
    )
    ...
    sa.Column('vj_class', postgresql.ENUM(u'Theoric', u'Adapted', u'RealTime', name='vj_classification'), nullable=False),
    sa.ForeignKeyConstraint(['meta_vj'], [u'navitia.meta_vj.id'], name=u'rel_metavj_vj_meta_vj_fkey'),
    sa.ForeignKeyConstraint(['vehicle_journey'], [u'navitia.vehicle_journey.id'], name=u'rel_metavj_vj_vehicle_journey_fkey'),
    schema='navitia'
    )

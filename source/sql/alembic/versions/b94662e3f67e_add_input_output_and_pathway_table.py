...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('pathway_mode', sa.TEXT(), nullable=False),
        sa.Column('is_bidirectional', sa.TEXT(), nullable=False),
        sa.Column('length', sa.TEXT(), nullable=True),
        sa.Column('traversal_time', sa.TEXT(), nullable=True),
        sa.Column('stair_count', sa.TEXT(), nullable=True),
        sa.Column('max_slope', sa.TEXT(), nullable=True),
        sa.Column('min_width', sa.TEXT(), nullable=True),

...
default_traveler_profile_params = {
    'standard': {'traveler_type': 'standard',
                 'walking_speed': 1.11,
                 'bike_speed': 3.33,
                 'bss_speed': 3.33,
                 'car_speed': 11.11,
    ...
    'slow_walker': {'traveler_type': 'slow_walker',
                    'walking_speed': 0.83,
                    'bike_speed': 2.77,
                    'bss_speed': 2.77,
                    'car_speed': 11.11,
    ...
    'fast_walker': {'traveler_type': 'fast_walker',
                    'walking_speed': 1.67,
                    'bike_speed': 4.16,
                    'bss_speed': 4.16,
                    'car_speed': 11.11,
    ...
    'wheelchair': {'traveler_type': 'wheelchair',
                   'walking_speed': 0.83,
                   'bike_speed': 3.33,
                   'bss_speed': 3.33,
                   'car_speed': 11.11,
    ...
    # Temporary Profile
    'motorist': {'traveler_type': 'motorist',
                 'walking_speed': 1.11,
                 'bike_speed': 3.33,
                 'bss_speed': 3.33,
                 'car_speed': 11.11,

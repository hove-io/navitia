...
MACRO(MAKE_WS)
    PARSE_ARGUMENTS(WS "NAME;SOURCES;LIBS" "FCGI;ISAPI;DUMMY;QT;ZMQ" ${ARGN})
  ...
  ELSEIF(WS_ZMQ)
    MESSAGE("Création du webservice ${WS_NAME} en zmq")
  ELSE(WS_FCGI)
    IF(WIN32)
      #ADD_DEFINITIONS(-DWS_TYPE=2)
      SET(WS_ISAPI TRUE)
  ...
  ELSEIF(WS_ZMQ)
    add_executable(${WS_NAME} ${WS_SOURCES})
    target_link_libraries(${WS_NAME} ${WS_LIBS} zmq pb_lib)
SET_TARGET_PROPERTIES(${WS_NAME} PROPERTIES COMPILE_FLAGS -DWS_TYPE=5)
  ELSEIF(WS_QT)

...
MACRO(MAKE_WS)
  ...
  SET(WS_SOURCES ${WS_SOURCES} ${CMAKE_SOURCE_DIR}/WS_commons/configuration.cpp ${CMAKE_SOURCE_DIR}/WS_commons/configuration.h ${CMAKE_SOURCE_DIR}/WS_commons/data_structures.h)
  IF(WS_FCGI)
  ...
  ELSEIF(WS_ISAPI)
    ...
    IF(MSVC)
	  ...
	  #gestion temporaire du probléme de link static sous windows
      SET_TARGET_PROPERTIES(${WS_NAME} PROPERTIES LINK_FLAGS "/NODEFAULTLIB:\"msvcprtd.lib;MSVCRTD.lib\"")
    ELSE(MSVC)
  ...
  add_executable(q${WS_NAME} ${WS_SOURCES} ${qt_UI} ${qt_MOC} ${CMAKE_SOURCE_DIR}/WS_commons/qt/main.h)
  INCLUDE_DIRECTORIES(${CMAKE_CURRENT_BINARY_DIR} ${CMAKE_SOURCE_DIR}/WS_commons)
  IF(MSVC)
	target_link_libraries(q${WS_NAME} ${QT_LIBRARIES} ${WS_LIBS})
	#gestion temporaire du probléme de link static sous windows
	SET_TARGET_PROPERTIES(q${WS_NAME} PROPERTIES LINK_FLAGS "/NODEFAULTLIB:\"msvcprtd.lib;MSVCRTD.lib\"")
   ELSE(MSVC)

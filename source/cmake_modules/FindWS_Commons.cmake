...
MACRO(MAKE_WS)
  ...
  IF(WS_FCGI)
    ...
    add_executable(${WS_NAME} ${WS_SOURCES} ${CMAKE_SOURCE_DIR}/WS_commons/configuration.h ${CMAKE_SOURCE_DIR}/WS_commons/configuration.cpp ${CMAKE_SOURCE_DIR}/WS_commons/data_structures.h)
  ...
  ELSEIF(WS_ISAPI)
    ...
    add_library(${WS_NAME} SHARED ${WS_SOURCES} ${CMAKE_SOURCE_DIR}/WS_Commons/export.def ${CMAKE_SOURCE_DIR}/WS_commons/configuration.h ${CMAKE_SOURCE_DIR}/WS_commons/configuration.cpp ${CMAKE_SOURCE_DIR}/WS_commons/data_structures.h)
  ...
  add_executable(q${WS_NAME} ${WS_SOURCES} ${qt_UI} ${qt_MOC} ${CMAKE_SOURCE_DIR}/WS_commons/qt/main.h ${CMAKE_SOURCE_DIR}/WS_commons/configuration.h ${CMAKE_SOURCE_DIR}/WS_commons/configuration.cpp ${CMAKE_SOURCE_DIR}/WS_commons/data_structures.h)
  INCLUDE_DIRECTORIES(${CMAKE_CURRENT_BINARY_DIR} ${CMAKE_SOURCE_DIR}/WS_commons)
  target_link_libraries(q${WS_NAME} ${QT_LIBRARIES} ${WS_LIBS} ${Boost_LIBRARIES})
  SET_TARGET_PROPERTIES(q${WS_NAME} PROPERTIES COMPILE_FLAGS -DWS_TYPE=4)

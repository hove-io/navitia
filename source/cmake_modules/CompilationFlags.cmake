...
if(${_PROJ_LIB_VERSION} LESS_EQUAL 400)
    add_definitions("-DPROJ_API_VERSION_MAJOR_4")
endif()
if(${_PROJ_LIB_VERSION} GREATER_EQUAL 600)
    add_definitions("-DPROJ_API_VERSION_MAJOR_6")
endif()
if(${_PROJ_LIB_VERSION} GREATER 400 AND ${_PROJ_LIB_VERSION} LESS 600)
    message(FATAL_ERROR "-- Proj Library '${_PROJ_LIB_VERSION}' not supported ...")
endif()

...
exec_program(proj OUTPUT_VARIABLE PROJ_LIB_VERSION RETURN_VALUE _result)
if("${_result}" EQUAL 0)
    string(REGEX MATCH "([0-9]+).([0-9]+).([0-9]+)" _PROJ_LIB_VERSION "${PROJ_LIB_VERSION}")
    message("-- Found Proj Library : ${_PROJ_LIB_VERSION}")
    string(REGEX REPLACE "^([0-9]+).*" "\\1" _PROJ_API_VERSION_MAJOR "${_PROJ_LIB_VERSION}")
    add_definitions("-DPROJ_API_VERSION_MAJOR_${_PROJ_API_VERSION_MAJOR}")
else()
    message(FATAL_ERROR "Could not find version of Proj Library ...")
endif()

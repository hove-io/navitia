...
const navitia::routing::Path string_to_path(const std::vector<std::string>& keys, const nt::Data& d) {
...
BOOST_AUTO_TEST_CASE(test_computation) {
    ...
    navitia::fare::results res = f.compute_fare(string_to_path(keys, navitia_data));

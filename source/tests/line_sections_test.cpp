...
int main(int argc, const char* const argv[]) {
    ...
    navitia::apply_disruption(b.disrupt(nt::RTLevel::Adapted, "line_section_on_line_1")
                              .tag("section_line_1")
                              .impact()
                              ...
                              .on(navitia::type::Type_e::Network, "base_network")
                              .on_line_section("line:1", "C", "E", {"route:line:1:1", "route:line:1:3"})
                              .get_disruption(),
                              *b.data->pt_data, *b.data->meta);

    navitia::apply_disruption(b.disrupt(nt::RTLevel::Adapted, "line_section_on_line_1_other_effect")
                              .tag("other_effect")
                              .impact()

...
int main(int argc, const char* const argv[]) {
    ...
    b.vj("X", "11100111")
        .route("route_1")
        .uri("X:vj2")("X_S1", "22:10"_t)("X_S2", "22:40"_t)("X_S3", "40:00"_t)("X_S4", "40:40"_t)
        .make();
    b.vj("X", "11100111")
        .route("route_1")
        .uri("X:vj3")("X_S1", "22:20"_t)("X_S2", "22:50"_t)("X_S3", "40:10"_t)("X_S4", "40:50"_t)
        .make();

    b.vj("X", "00011000")
        .route("route_1")
        .uri("X:vj4")("X_S1", "22:05"_t)("X_S2", "22:35"_t)("X_S3", "39:55"_t)("X_S4", "40:35"_t)
        .make();
    b.vj("X", "00011000")
        .route("route_1")
        .uri("X:vj5")("X_S1", "22:15"_t)("X_S2", "22:45"_t)("X_S3", "40:05"_t)("X_S4", "40:45"_t)
        .make();
    b.vj("X", "00011000")
        .route("route_1")
        .uri("X:vj6")("X_S1", "22:25"_t)("X_S2", "22:55"_t)("X_S3", "40:15"_t)("X_S4", "40:55"_t)
        .make();

    b.vj("X", "11111111")
        .route("route_2")
        .uri("X:vj7")("X_S4", "22:00"_t)("X_S3", "22:40"_t)("X_S2", "39:40"_t)("X_S1", "40:20"_t)
        .make();
    b.vj("X", "11111111")
        .route("route_2")
        .uri("X:vj8")("X_S4", "22:05"_t)("X_S3", "22:45"_t)("X_S2", "39:45"_t)("X_S1", "40:25"_t)
        .make();

        ...
        do {
            std::string request =
                (boost::format(
                     ...
                     "     extract(epoch from ls_start.created_at  AT TIME ZONE 'UTC') :: bigint as "
                     "ls_start_created_at,"
                     "     extract(epoch from ls_start.updated_at  AT TIME ZONE 'UTC') :: bigint as "
                     "ls_start_updated_at,"
                     ...
                     "     extract(epoch from ls_route.created_at  AT TIME ZONE 'UTC') :: bigint as "
                     "ls_route_created_at,"
                     "     extract(epoch from ls_route.updated_at  AT TIME ZONE 'UTC') :: bigint as "
                     "ls_route_updated_at,"
                     ...
                     "     extract(epoch from rs_start.created_at  AT TIME ZONE 'UTC') :: bigint as "
                     "rs_start_created_at,"
                     "     extract(epoch from rs_start.updated_at  AT TIME ZONE 'UTC') :: bigint as "
                     "rs_start_updated_at,"
                     ...
                     "     extract(epoch from rs_route.created_at  AT TIME ZONE 'UTC') :: bigint as "
                     "rs_route_created_at,"
                     "     extract(epoch from rs_route.updated_at  AT TIME ZONE 'UTC') :: bigint as "
                     "rs_route_updated_at,"

...
BOOST_AUTO_TEST_CASE(direct){
    ...
    res1 = raptor.compute(d.stop_areas_map["stop1"], d.stop_areas_map["stop2"], 9200, 0, DateTimeUtils::set(0,8050-1000), type::RTLevel::Base, 2_min, false);
    ...
    res1 = raptor.compute(d.stop_areas_map["stop1"], d.stop_areas_map["stop2"], 9200, 0, DateTimeUtils::set(0, 8050-1), type::RTLevel::Base, 2_min, false);
    ...
    res1 = raptor.compute(d.stop_areas_map["stop1"], d.stop_areas_map["stop2"], 9200, 0, DateTimeUtils::set(0, 8050), type::RTLevel::Base, 2_min, false);
...
BOOST_AUTO_TEST_CASE(change){
    ...
    auto res1 = raptor.compute(d.stop_areas_map["stop1"], d.stop_areas_map["stop5"], 13000, 0, DateTimeUtils::min, type::RTLevel::Base, 2_min, false);
    BOOST_REQUIRE_EQUAL(res1.size(), 1);
    ...
    res1 = raptor.compute(d.stop_areas_map["stop1"], d.stop_areas_map["stop5"], 13000, 0, DateTimeUtils::set(0, 8050-1000), type::RTLevel::Base, 2_min, false);
    BOOST_REQUIRE_EQUAL(res1.size(), 1);
    ...
    res1 = raptor.compute(d.stop_areas_map["stop1"], d.stop_areas_map["stop5"], 13000, 0, DateTimeUtils::set(0, 8050-1), type::RTLevel::Base, 2_min, false);
    BOOST_REQUIRE_EQUAL(res1.size(), 1);
    ...
    res1 = raptor.compute(d.stop_areas_map["stop1"], d.stop_areas_map["stop5"], 13000, 0, DateTimeUtils::set(0, 8050), type::RTLevel::Base, 2_min, false);
    BOOST_REQUIRE_EQUAL(res1.size(), 0);
}
...
BOOST_AUTO_TEST_CASE(passe_minuit){
    ...
    auto res1 = raptor.compute(d.stop_areas_map["stop1"], d.stop_areas_map["stop3"], 22*3600, 1, DateTimeUtils::min, type::RTLevel::Base, 2_min, false);
    BOOST_REQUIRE_EQUAL(res1.size(), 1);
    ...
    res1 = raptor.compute(d.stop_areas_map["stop1"], d.stop_areas_map["stop3"], 22*3600, 1, DateTimeUtils::set(0, 23*3600-1000), type::RTLevel::Base, 2_min, false);
    BOOST_REQUIRE_EQUAL(res1.size(), 1);
    ...
    res1 = raptor.compute(d.stop_areas_map["stop1"], d.stop_areas_map["stop3"], 22*3600, 1, DateTimeUtils::set(0, 23*3600-1), type::RTLevel::Base, 2_min, false);
    BOOST_REQUIRE_EQUAL(res1.size(), 1);
    ...
    res1 = raptor.compute(d.stop_areas_map["stop1"], d.stop_areas_map["stop3"], 22*3600, 1, DateTimeUtils::set(0, 23*3600), type::RTLevel::Base, 2_min, false);
    BOOST_REQUIRE_EQUAL(res1.size(), 0);
}
...
BOOST_AUTO_TEST_CASE(passe_minuit_interne){
    ...
    auto res1 = raptor.compute(d.stop_areas_map["stop1"], d.stop_areas_map["stop3"], 50*60, 1, DateTimeUtils::min, type::RTLevel::Base, 2_min, false);
    BOOST_REQUIRE_EQUAL(res1.size(), 1);
    ...
    res1 = raptor.compute(d.stop_areas_map["stop1"], d.stop_areas_map["stop3"],  50*60, 1, DateTimeUtils::set(0, 23*3600 - 1000), type::RTLevel::Base, 2_min, false);
    BOOST_REQUIRE_EQUAL(res1.size(), 1);
    ...
    res1 = raptor.compute(d.stop_areas_map["stop1"], d.stop_areas_map["stop3"], 50*60, 1, DateTimeUtils::set(0, 23*3600-1), type::RTLevel::Base, 2_min, false);
    BOOST_REQUIRE_EQUAL(res1.size(), 1);
    ...
    res1 = raptor.compute(d.stop_areas_map["stop1"], d.stop_areas_map["stop3"], 50*60, 1, DateTimeUtils::set(0, 23*3600), type::RTLevel::Base, 2_min, false);
    BOOST_REQUIRE_EQUAL(res1.size(), 0);
}
...
BOOST_AUTO_TEST_CASE(passe_minuit4){
    ...
    auto res1 = raptor.compute(d.stop_areas_map["stop1"], d.stop_areas_map["stop2"],
            24*3600+15*60, 3, DateTimeUtils::min, nt::RTLevel::Base, 2_min, false);
    BOOST_REQUIRE_EQUAL(res1.size(), 1);
...
BOOST_AUTO_TEST_CASE(validity_pattern){
    ...
    auto res = raptor.compute(d.stop_areas_map["stop1"], d.stop_areas_map["stop2"], 7000, 1, DateTimeUtils::min, type::RTLevel::Base, 2_min, false);
...
BOOST_AUTO_TEST_CASE(marche_a_pied_milieu){
    ...
    auto res1 = raptor.compute(d.stop_areas_map["stop1"], d.stop_areas_map["stop4"], 27900, 0, DateTimeUtils::min, type::RTLevel::Base, 2_min, false);
    ...
    res1 = raptor.compute(d.stop_areas_map["stop1"], d.stop_areas_map["stop4"], 27900, 0, DateTimeUtils::set(0, 8050 - 1000), type::RTLevel::Base, 2_min, false);
    ...
    res1 = raptor.compute(d.stop_areas_map["stop1"], d.stop_areas_map["stop4"], 27900, 0, DateTimeUtils::set(0, 8050-1), type::RTLevel::Base, 2_min, false);
    ...
    res1 = raptor.compute(d.stop_areas_map["stop1"], d.stop_areas_map["stop4"], 27900, 0, DateTimeUtils::set(0, 8050), type::RTLevel::Base, 2_min, false);
...
BOOST_AUTO_TEST_CASE(stay_in_basic) {
    ...
    auto res1 = raptor.compute(d.stop_areas_map["stop1"], d.stop_areas_map["stop3"], 8*3600 + 25*60, 0, DateTimeUtils::min, nt::RTLevel::Base, 2_min, false);
...
BOOST_AUTO_TEST_CASE(stay_in_3_vj) {
    ...
    auto res1 = raptor.compute(d.stop_areas_map["stop1"], d.stop_areas_map["stop3"], 8*3600 + 35*60, 0, DateTimeUtils::min, nt::RTLevel::Base, 2_min, false);
    BOOST_REQUIRE_EQUAL(res1.size(), 1);
...
BOOST_AUTO_TEST_CASE(stay_in_invalid_vp) {
    ...
    auto res1 = raptor.compute(d.stop_areas_map["stop1"], d.stop_areas_map["stop3"], 5*60, 0, DateTimeUtils::inf, nt::RTLevel::Base, 2_min, false);
    BOOST_REQUIRE_EQUAL(res1.size(), 0);
}
...
BOOST_AUTO_TEST_CASE(itl) {
    ...
    auto res1 = raptor.compute(d.stop_areas_map["stop1"], d.stop_areas_map["stop2"], 9*3600+15*60, 0, DateTimeUtils::min, type::RTLevel::Base, 2_min, false);

    BOOST_REQUIRE_EQUAL(res1.size(), 0);


    res1 = raptor.compute(d.stop_areas_map["stop1"], d.stop_areas_map["stop3"], 8*3600+20*60, 0, DateTimeUtils::min, type::RTLevel::Base, 2_min, false);
    BOOST_REQUIRE_EQUAL(res1.size(), 1);
...
BOOST_AUTO_TEST_CASE(mdi) {
    ...
    auto res1 = raptor.compute(d.stop_areas_map["stop1"], d.stop_areas_map["stop3"], 17*3600+30*60, 0, DateTimeUtils::min, type::RTLevel::Base, 2_min, false);
    BOOST_CHECK_EQUAL(res1.size(), 0);
    res1 = raptor.compute(d.stop_areas_map["stop2"], d.stop_areas_map["stop3"], 17*3600+30*60, 0, DateTimeUtils::min, type::RTLevel::Base, 2_min, false);
    BOOST_CHECK_EQUAL(res1.size(), 1);

    res1 = raptor.compute(d.stop_areas_map["stop4"], d.stop_areas_map["stop6"], 17*3600+30*60, 0, DateTimeUtils::min, type::RTLevel::Base, 2_min, false);
    BOOST_CHECK_EQUAL(res1.size(), 0);
    res1 = raptor.compute(d.stop_areas_map["stop4"], d.stop_areas_map["stop5"], 17*3600+30*60, 0, DateTimeUtils::min, type::RTLevel::Base, 2_min, false);
    BOOST_CHECK_EQUAL(res1.size(), 1);
}
...
BOOST_AUTO_TEST_CASE(max_duration){
    ...
    auto res1 = raptor.compute(d.stop_areas_map["stop1"], d.stop_areas_map["stop2"], 8200, 0, DateTimeUtils::min, type::RTLevel::Base, 2_min, false);
    BOOST_REQUIRE_EQUAL(res1.size(), 1);

    res1 = raptor.compute(d.stop_areas_map["stop1"], d.stop_areas_map["stop2"], 8200, 0, DateTimeUtils::set(0, 8049), type::RTLevel::Base, 2_min, false);
    BOOST_REQUIRE_EQUAL(res1.size(), 1);

    res1 = raptor.compute(d.stop_areas_map["stop1"], d.stop_areas_map["stop2"], 8200, 0, DateTimeUtils::set(0, 8051), type::RTLevel::Base, 2_min, false);
    BOOST_REQUIRE_EQUAL(res1.size(), 0);
}
...
BOOST_AUTO_TEST_CASE(max_transfers){
    ...
    for(uint32_t nb_transfers=0; nb_transfers<=2;++nb_transfers) {
        auto res1 = raptor.compute(d.stop_areas_map["stop1"], d.stop_areas_map["stop2"], 86400, 0, DateTimeUtils::inf, nt::RTLevel::Base, 2_min, true, type::AccessibiliteParams(), nb_transfers);
